...
@@ CRIAR A FORMA DE INTEGRAÇÃO EM TEMPO REAL COM OS BANCOS DE DADOS DO BOOKING E AIRBNB INICIALMENTE 
...
@@COLOCAR NESTA PARTE QUAIS HORÁROPS SERÃO FEITOS O CHECKOUT E QUAL A FUNCIONÁRIA QUE ESTÁ DESIGNADA PARA A ARRUMAÇÃO PARA O PRÓXIMO HÓSPEDE, 
@@ O SISTEMA DEVERÁ VERIFICAR TAMBÉM NA PRÓXIMA HOSPEDAGEM QUANTOS HÓSPEDES FICARÃO HOSPEDADOS E DAR O FEEDBACK PARA A PRESTADORA DE SERVIÇOS ATRAVÉS 
@@ DE WHATTSAPP DE QUANTAS TOALHAS DEVEM SER COLOCADAS EM CADA UNIDADE, FAZENDO SEMPRE UMA ADVERTÊNCIA PARA ELA VERIFICAR SE HÁ PAPEL HIGIÊNICO E SE O 
@@ MICROONDAS E FRIGOBAR ESTÃO LIMPOS 
...
@@ AO PASSAR POR CIMA DA UNIDADE O SISTEMA PODERÁ DAR UMA PRÉVIA RESUMIDA DO STATUS REAL DA UNIDADE NESTE MOMENTO, PODENDO HAVER UM BOTÃO QUE INDIQUE
@@ A NECESSIDADE DE AVISAR A PRESTADORA DE SERVIÇOS QUE É NECESSÁRIO DAR PRIORIDADE NA ARRUMAÇÃO DESTA UNIDADE POIS O HOSPEDE AVISOU QUE CHEGARÁ EXATAMENTE
@@  NO HORÁRIO DE CHECK IN OU FOI AUTORIZADO O EARLY CHECK IN, CASO TENHA SIDO AUTORIZADO O EARLY CHECK IN VERIFICAR DE ELE FOI SEM ÔNUS OU PAGO, QUANDO 
@@  PAGO O APARTAMENTO DEVERÁ ESTAR PRONTO AS 9:00 DA MANHÃ NO MÁXIMO. 
...
@@ VERIFICAR O MÁXIMO DE INFORMAÇÕES QUE O SISTEMA CONSEGUE PUXAR DIRETAMENTE DO BOOKING/AIRBNB PARA FORNECER DE FORMA IGUAL PARA O USUÁRIO NÃO SENTIR
@@ MUITA DIFERENÇA AO UTILIZAR NOSSO COCKPIT, SERIA INCLUSIVE BOM UTILIZAR CORES E FORMATAÇÃO PARECIDA, MAS MAIS INTUITIVA PARA O USUÁRIO SE SENTIR COMO 
@@ SE ESTIVESSE EM UM PAINEL ACESSÓRIO AO BOOKING QUE É NOSSA PLATAFORMA PRINCIPAL DE TRABALHO
...
@@ O SISTEMA DEVERÁ CONSOLIDAR OS DADOS DAS RESERVAS FUTURAS E PASSADAS, PONDENDO DAR OPÇÃO PARA O CLIENTE FILTRAR POR DATA, EXPORTAR RELATÓRIOS E
@@ FAZER O PLANEJAMENTO FUTURO DE RECEITAS E DESPESAS
...
@@ CRIAR UM APLICATIVO OU UMA INTERFACE INTUITIVA QUE A PRESTADORA DE SERVIÇOS POSSA TER EM MÃOS PARA DAR O CHECK DE QUE FEZ A VERIFICAÇÃO E O SISTEMA 
@@ ANOTAR DATA E HORÁRIO QUE FOI FEITA A HIGIENIZAÇÃO, POR QUEM E ETC.
...
@@ DEVE TER UMA OPÇÃO PARA A PRESTADORA DE SERVIÇOS AVALIAR SE A ROUPA DE CAMA ESTÁ SEM USO E PODE SER REUTILIZADA NA PRÓXIMA ESTADIA, ELA TAMBÉM DEVERÁ 
@@ DIZER QUANTAS TOALHAS E ROUPAS DE CAMA ESTÁ RETIRANDO PARA LIMPEZA, NO MESMO CHECKLIST ELA DEVERÁ APONTAR SE SUMIU ALGUM ITEM COMO COPOS, SANDUICHEIRA, TRAVESSEIROS OU ITENS PEQUENOS DO IMÓVEL, PARA COBRANÇA OU REPOSIÇÃO. 
...
@@ pARA RESERVAS QUE RECEBEM NO FUTURO CONSTAR QUAIS SERÃO E AS DATAS DOS RECEBÍVEIS
...
@@ CRIAR UM MENU ONDE O APP TENTA PUXAR TODAS AS INFORMAÇÕES DO AIRBNB OU BOOKING E PERMITE QUE O UÁRIO CONFIRA E INSIRA MAIS OU CORRIJA
---
...
@@ TEREMOS 3 OPÇÕES QUE DEVEM ESTAR EM UMA CAIXA DE SELEÇÃO NO MOMENTO DO CADASTRO DA PRESTADORA DE SERVIÇOS, POIS CADA UMA SE´´A TRATADA DE 
@@ ACORDO COM O SEU REGIME DE CONTRATAÇÃO, AINDA DEVE SER INCLUÍDO MAIS UM CAMPO QUE É PARA EMPRESA TERCEIRIZADORA
...
@@ MAS GERENCIADO QUANTIDADE E NECESSIDADE DE TROCA PELO TITAN COMO SUGESTÃO NO COCKPIT
